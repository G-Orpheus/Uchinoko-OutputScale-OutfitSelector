...
_TERRARIA = {
    "SK_Player_Female_Outfit_Yakushima001": "テラリア: ホーリープレート(女)",
    "SK_Player_Male_Outfit_Yakushima001": "テラリア: ホーリープレート(男)",
    "SK_YakushimaHeadEquip001": "テラリア: ホーリーマスク",
    "SK_YakushimaHeadEquip002": "テラリア: ホーリーヘッドギア",
    "SK_YakushimaHeadEquip003": "テラリア: ホーリーヘルム",
    "SK_YakushimaHeadEquip004": "テラリア: ホーリーフード",
    "SK_YakushimaHeadEquip005": "テラリア: ムーンロードのおめん",
    "SK_YakushimaHeadEquip006": "テラリア: クトゥルフのめだまマスク",
}
...
_ULTRAKILL = {
    "SK_Player_Male_Outfit_Octavia001": "ULTRAKILL: V1/V2アーマー(男)",
    "SK_Player_Female_Outfit_Octavia001": "ULTRAKILL: V1/V2アーマー(女、バニラに存在しない可能性あり)",
    "SK_Player_Male_Outfit_Octavia001_v01": "ULTRAKILL: V1アーマー",
    "SK_Player_Male_Outfit_Octavia001_v02": "ULTRAKILL: V2アーマー",
    "SK_Player_Female_Outfit_Octavia001_v01": "ULTRAKILL: V1アーマー(女)",
    "SK_Player_Female_Outfit_Octavia001_v02": "ULTRAKILL: V2アーマー(女)",
}
...
def summary():
    return (f"非対応(コラボ系) SK {len(EXCLUDED_SK_NAMES)}件 / "
            f"パス一致 {list(EXCLUDED_PATH_SUBSTRINGS)}")
